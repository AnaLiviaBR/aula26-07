<?php 
	...
	// errNome será true se o campo nome for inválido(se tiver errNome) e false se o campo estiver ok. 
	...
	// errEmail será true se o campo senha for inválido e false se o campo estiver ok. 
		...
		<div class="row">
			...
			<form class="col-sm-12 col-md-8" action="index.php" method="post">
				...
				<div class="form-group">
					...
					<input value="" type="text" class="form-control" <?= ($errNome?'is-invalid':'')?> id="nome" name="nome" placeholder="Digite o nome do funcionário">    <!--Erro no nome é true? Se for coloque is-invalide e pinte de vermelho-->
				...
				<div class="form-group">
					...
					<input value="" type="password" class="form-control <?= ($errSenha?'is-invalid':'')?>"  id="senha" name="senha" placeholder="Digite uma senha para o funcionário">
					<?php if($errSenha): ?><div class="invalid-feedback">Preencha a senha corretamente.</div><?php endif; ?>
				</div>

				<div class="form-group">
					<label for="conf">Confirmação</label>
					<input value="" type="password" class="form-control <?= ($errConf?'is-invalid':'')?>"  id="conf" name="conf" placeholder="Confirme a senha">
